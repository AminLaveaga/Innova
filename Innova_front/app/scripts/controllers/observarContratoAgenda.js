angular.module('innovaFrontApp').controller('observarContratoAgendaCtrl',['$scope','contratoService','$uibModalInstance','obj','$controller',function($scope,contratoService,$uibModalInstance,obj,$controller){
